    ...
    return (
      <div style={{ background: '#111', borderRadius: '16px', border: '1px solid #333', display: 'flex', overflow: 'hidden' }}>
        ...
        <div style={{ flex: 1, padding: '50px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
          ...
          <h3 style={{ fontSize: '36px', margin: '0 0 20px', lineHeight: 1.2, display: 'flex', alignItems: 'center', gap: '12px' }}>
            <Rocket size={32} strokeWidth={1.5} className="hover-orange-icon" /> Welcome to CS Vertex
          </h3>
          ...
          <a href="#quote" className="primary-action group" style={{ width: 'fit-content' }}>
            <span>Request Quote</span><ArrowUpRight size={18} strokeWidth={2} className="hover-orange-icon" />
          </a>
        </div>
      </div>
    )
  ...
  return (
    <div style={{ background: '#111', borderRadius: '16px', border: '1px solid #333', display: 'flex', overflow: 'hidden', flexWrap: 'wrap' }}>
      ...
      <div style={{ flex: '2 1 400px', padding: '50px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        ...
        <a href="#quote" className="primary-action group" style={{ width: 'fit-content' }}>
          <span>Explore Now</span><ArrowUpRight size={18} strokeWidth={2} className="hover-orange-icon" />
        </a>
      </div>
    </div>
  )
